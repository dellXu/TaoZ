//
//  MyAccountEditPhoneViewController.m
//  TaoZ
//
...
@interface MyAccountEditPhoneViewController ()

@end

@implementation MyAccountEditPhoneViewController
...
-(void)layOutSelfView
{
    ...
    UITextField *nameTextField = [[UITextField alloc]initWithFrame:CGRectMake(95, 0, 202, 40)];
